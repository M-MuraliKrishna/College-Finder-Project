...
class WeatherApp:
    global url,apiKey
    apiKey = 'a0c200183585f96b630aae90f1470d53'
    url = 'https://api.openweathermap.org/data/2.5/weather?q={}&appid={}'
    
    
    def __init__(self,root):
        self.root = root
        self.root.title("Check Weather") 
        ...
        def searched_for(root):
            ...
            if weather:
                ...
                img["file"] = f'D:/CF-DS/News App FIles/img//{weather[4]}.png'
        ...
        locationLabel = Label(root,text='',bg='#098296',fg='white',font=('rockwell bold',30))
        locationLabel.pack()
        
        introLabel = Label(root,text='Search by - City/State/Country',font=('rockwell bold',16),bg='#098296',fg='white')
        introLabel.pack()
        
        img = PhotoImage(file='')
        image = Label(root,image=img,bg='#098296',fg='white')
        image.pack()
        
        temperatureLabel = Label(root,text='',font=('rockwell bold',21),bg='#098296',fg='white')
        temperatureLabel.pack()
        
        
        weatherLabel = Label(root,text='',font=('rockwell bold',21),bg='#098296',fg='white')
        weatherLabel.pack()
